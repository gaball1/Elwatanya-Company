...
export class PrismaSubcontractorStatementRepository implements ISubcontractorStatementRepository {
  ...
  private toDomain(record: any): SubcontractorStatement {
    return SubcontractorStatement.reconstitute({
      ...
      formNumber: record.formNumber, insurancePercent: record.insurancePercent,
      totalWorkValue: record.totalWorkValue, totalInsurance: record.totalInsurance,
      totalDeductions: record.totalDeductions, previousPaid: record.previousPaid,
      netPayable: record.netPayable, runningNumber: record.runningNumber,
